...
import { COLORS, SPACING, BORDER_RADIUS, type UserRole, type UserStatus } from '../../lib/shared';
...
export default function VerifyOtpScreen() {
  ...
  const handleVerify = async (code?: string) => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : t.otp.invalidCode;
      setError(message);
        ...
        <View style={styles.resendContainer}>
          {canResend ? (
            ...
            <View style={styles.timerRow}>
              <Text style={styles.timerLabel}>{t.otp.resendIn(timer)} </Text>
